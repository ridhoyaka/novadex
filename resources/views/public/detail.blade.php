        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <nav class="mb-6" aria-label="Breadcrumb">
                <ol class="flex items-center space-x-2 text-sm">
                    <li>
                        <a href="{{ route('home') }}" class="text-gray-400 hover:text-gold-400 transition-colors">
                            Beranda
                        </a>
                    </li>
                    <li class="text-gray-600">/</li>
                    <li>
                        <a href="{{ route('umkm.index') }}" class="text-gray-400 hover:text-gold-400 transition-colors">
                            Katalog UMKM
                        </a>
                    </li>
                    <li class="text-gray-600">/</li>
                    <li>
                        <a href="{{ route('umkm.index', ['kategori' => $umkm->kategori_id]) }}" class="text-gray-400 hover:text-gold-400 transition-colors">
            ...
            <!-- Back Button -->
            <div class="mb-8">
                <a href="{{ route('umkm.index') }}" class="inline-flex items-center gap-2 text-gray-400 hover:text-gold-400 font-medium transition-colors">
            ...
            <!-- Header -->
            <div class="bg-arsa-800 border border-arsa-700 rounded-xl p-8 mb-8">
                <div class="flex flex-col md:flex-row items-start gap-8">
                    <div class="w-40 h-40 bg-arsa-700 rounded-xl flex items-center justify-center flex-shrink-0">
                        @if($umkm->logo_path)
                    ...
                    <div class="flex-1">
                        <h1 class="text-4xl font-black text-white mb-4">{{ $umkm->nama_usaha }}</h1>
                        <div class="flex flex-wrap gap-3 mb-4">
                            <span class="inline-flex items-center gap-2 bg-arsa-700 border border-arsa-700 text-gray-300 px-4 py-2 rounded-xl font-semibold">
            ...
            <div class="bg-arsa-800 border border-arsa-700 rounded-xl p-8 mb-8">
                <div class="flex items-center justify-between mb-4">
                    ...
                    <div class="flex items-center gap-2">
                        <span class="text-sm text-gray-400 mr-2">Bagikan:</span>
                        <!-- Facebook -->
                        <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url()->current()) }}" 
                           target="_blank"
                           class="w-10 h-10 bg-blue-600 hover:bg-blue-700 rounded-xl flex items-center justify-center transition-colors"
                        ...
                        <a href="https://twitter.com/intent/tweet?url={{ urlencode(url()->current()) }}&text={{ urlencode($umkm->nama_usaha . ' - ' . $umkm->category->nama_kategori) }}" 
                           target="_blank"
                           class="w-10 h-10 bg-sky-500 hover:bg-sky-600 rounded-xl flex items-center justify-center transition-colors"
                        ...
                        <a href="https://wa.me/?text={{ urlencode($umkm->nama_usaha . ' - ' . url()->current()) }}" 
                           target="_blank"
                           class="w-10 h-10 bg-green-600 hover:bg-green-700 rounded-xl flex items-center justify-center transition-colors"
                        ...
                        <button onclick="copyToClipboard('{{ url()->current() }}')" 
                                class="w-10 h-10 bg-arsa-700 hover:bg-arsa-600 border border-arsa-700 rounded-xl flex items-center justify-center transition-colors"
                                title="Salin Link">
                ...
                <p class="text-gray-300 text-lg leading-relaxed whitespace-pre-line">{{ $umkm->deskripsi }}</p>
            </div>
            ...
            <div class="bg-arsa-800 border border-arsa-700 rounded-xl p-8 mb-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-start gap-3 text-gray-300">
                        <svg class="w-5 h-5 text-gold-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                    ...
                    <div class="bg-arsa-700 rounded-xl p-4 border border-arsa-700">
                        <div class="aspect-video bg-arsa-600 rounded-xl overflow-hidden mb-4">
                            <iframe 
                                width="100%" 
                                height="100%" 
                                frameborder="0" 
                        ...
                        <a href="https://www.google.com/maps?q={{ $umkm->latitude }},{{ $umkm->longitude }}" 
                           target="_blank"
                           class="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-xl hover:bg-blue-700 transition-all font-semibold">
            ...
            <div class="bg-arsa-800 border border-arsa-700 rounded-xl p-8 mb-8">
                ...
                <div class="flex items-center gap-3 text-gray-400 bg-arsa-700 border border-arsa-700 rounded-xl p-4">
            ...
            <!-- Contact -->
            <div class="bg-gradient-to-br from-gold-500/10 to-gold-600/10 border border-gold-500/30 rounded-xl p-8 mb-8">
                <h2 class="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                    <svg class="w-6 h-6 text-gold-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p class="text-gray-300 mb-6">Tertarik dengan produk atau layanan kami? Hubungi kami langsung melalui WhatsApp!</p>
                <a href="{{ $umkm->whatsapp_link }}" target="_blank" 
                   class="inline-flex items-center gap-3 bg-green-600 text-white px-8 py-4 rounded-xl hover:bg-green-700 transition-all font-bold text-lg">
            ...
            <div class="bg-arsa-800 border border-arsa-700 rounded-xl p-8 mb-8">
                ...
                <p class="text-gray-400 mb-6">Jelajahi UMKM lainnya yang mungkin Anda minati</p>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    @foreach($relatedUmkm as $related)
                    <a href="{{ route('umkm.show', $related->slug) }}" class="group bg-arsa-700 border border-arsa-700 rounded-xl overflow-hidden hover:border-gold-500 transition-all">
                        <div class="aspect-video bg-arsa-600 flex items-center justify-center overflow-hidden">
                            ...
                            @else
                            <span class="text-5xl" role="img" aria-label="Ikon toko">🏪</span>
                            @endif
                        </div>
                        <div class="p-4">
                            <h3 class="font-bold text-white mb-2 group-hover:text-gold-400 transition-colors line-clamp-1">
                                {{ $related->nama_usaha }}
                            </h3>
                            <div class="flex flex-wrap gap-2 mb-2">
                                <span class="text-xs bg-arsa-600 text-gray-300 px-2 py-1 rounded">
            ...
            <div class="bg-arsa-800 border border-arsa-700 rounded-xl p-8">
                <h2 class="text-2xl font-bold text-white mb-6 flex items-center gap-2">
                    <svg class="w-6 h-6 text-gold-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                ...
                <p class="text-gray-400 mb-6">Lihat lokasi UMKM sejenis di sekitar area ini</p>
                
                <!-- Map Container -->
                <div id="nearby-map" class="w-full h-96 rounded-lg border border-arsa-700"></div>
                    ...
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        currentMarker.bindPopup(`
                            <div class="p-2" style="min-width: 200px;">
                                ...
                                <span class="inline-block bg-gold-500 text-white text-xs font-semibold px-2 py-1 rounded">
                                    📍 Lokasi Saat Ini
                                </span>
                            </div>
                        `);
